...
type UseOrganizationReturn<T extends UseOrganizationParams> = {
    ...
    subscriptions: PaginatedResources<__experimental_CommerceSubscriptionResource, T['subscriptions'] extends {
        infinite: true;
    } ? true : false> | null;
};
/**
